    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row g-3">
          <div class="col-md-6">
            <label class="form-label">NIM <span style="color:red">*</span></label>
            <input type="text" name="nim" id="edit_nim" class="form-control" minlength="5" maxlength="20" pattern="[0-9]+" title="Hanya angka yang diperbolehkan" required/>
          </div>
          <div class="col-md-6">
            <label class="form-label">Nama Lengkap <span style="color:red">*</span></label>
            <input type="text" name="nama" id="edit_nama" class="form-control" minlength="3" maxlength="100" required/>
          </div>
          <div class="col-md-6">
            <label class="form-label">Program Studi <span style="color:red">*</span></label>
            <input type="text" name="prodi" id="edit_prodi" class="form-control" maxlength="100" required/>
          </div>
        </div>
      </div>
      <div class="modal-footer border-top" style="border-color:var(--border)!important">
